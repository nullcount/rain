...
class ChanPointShim(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["amt", b"amt", "chan_point", b"chan_point", "local_key", b"local_key", "pending_chan_id", b"pending_chan_id", "remote_key", b"remote_key", "thaw_height", b"thaw_height"]) -> None: ...
