...
class Wos(TrustedSwapService):
    ...
    def get_address(self) -> Result[str, str]:
        ...
        # TODO: handle errors
        log(LOG_INFO, msg.ok.format('wos', addr))
        return Ok(addr)
    ...
    def get_balance(self) -> Result[int, str]:
        ...
        log(LOG_INFO, msg.ok.format('wos', balance))
        return Ok(balance)
    ...
    def get_invoice(self, sats: int) -> Result[str, str]:
        ...
        log(LOG_INFO, msg.ok.format('wos', invoice, sats))
        return Ok(invoice)
    ...
    def get_onchain_fee(self, sats: int) -> Result[int, str]:
        ...
        log(LOG_INFO, msg.ok.format('wos', sats, fee))
        return Ok(fee)
